...
<head>
  ...
  <style>
    ...
    .btn{display:inline-block;padding:8px 12px;border-radius:6px;border:1px solid #4a148c}
    ...
    form input, form textarea, form select{width:100%;padding:8px;border-radius:6px;border:1px solid #ccc}
